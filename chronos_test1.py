...
st.title("クロノクエスト")
st.caption("このアプリは 1 ヶ月間で、あなたの「やりたいのに続かないことを続けられる方法」を探すアプリです。")
st.caption("ゆきだまちゃんと一緒に毎日色んな方法でこれまで中々取り組めなかったことに取り組んでみよう!")

# 画像の表示
image = Image.open("クロノス.png")
st.image(image, width=300)
st.caption("やりたいのに続かないことってあるよね。")
st.caption("どーやったら続くか一緒に考えよ！まずは、あなたのことを教えて！")
